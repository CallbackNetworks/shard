...
- **Production-ready:** Separate multi-stage `Dockerfile.prod` per service, with the production compose file generated by the deploy pipeline — Nginx reverse proxy, optimized builds, and health checks
