...
export default function OfflineIndicator() {
  ...
  return (
    <div className="kt-offline-indicator" style={{
      ...
      background: isOnline ? DARK.elevated : 'color-mix(in srgb, var(--kt-hit) 15%, transparent)',
      border: `1px solid ${isOnline ? 'rgba(var(--kt-ink-rgb), 0.1)' : 'color-mix(in srgb, var(--kt-hit) 32%, transparent)'}`,
